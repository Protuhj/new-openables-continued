...
NOP.T_ITEMS = {                                                                                      -- [itemID] = {{count_to_use,priority},{"sub-Zone",...},{[mapID]=true,...},auraID}, table for opening/use item by itemID, when is no possible to check for any common text
  ...
  [111589] = { { 5, PRI_OPEN }, nil, nil },
  [111595] = { { 5, PRI_OPEN }, nil, nil },
  [111601] = { { 5, PRI_OPEN }, nil, nil }, -- Crescent Saberfish
  [111650] = { { 5, PRI_OPEN }, nil, nil },
  [111669] = { { 5, PRI_OPEN }, nil, nil },
  [111676] = { { 5, PRI_OPEN }, nil, nil }, -- Jawless Skulker
  [111651] = { { 5, PRI_OPEN }, nil, nil },
  [111668] = { { 5, PRI_OPEN }, nil, nil },
  [111675] = { { 5, PRI_OPEN }, nil, nil }, -- Fat Sleeper
  [111652] = { { 5, PRI_OPEN }, nil, nil },
  [111667] = { { 5, PRI_OPEN }, nil, nil },
  [111674] = { { 5, PRI_OPEN }, nil, nil }, -- Blind Lake Sturgeon
  [111656] = { { 5, PRI_OPEN }, nil, nil },
  [111666] = { { 5, PRI_OPEN }, nil, nil },
  [111673] = { { 5, PRI_OPEN }, nil, nil }, -- Fire Ammonite
  [111658] = { { 5, PRI_OPEN }, nil, nil },
  [111665] = { { 5, PRI_OPEN }, nil, nil },
  [111672] = { { 5, PRI_OPEN }, nil, nil }, -- Sea Scorpion
  [111659] = { { 5, PRI_OPEN }, nil, nil },
  [111664] = { { 5, PRI_OPEN }, nil, nil },
  [111671] = { { 5, PRI_OPEN }, nil, nil }, -- Abyssal Gulper Eel
  [111662] = { { 5, PRI_OPEN }, nil, nil },
  [111663] = { { 5, PRI_OPEN }, nil, nil },
  [111670] = { { 5, PRI_OPEN }, nil, nil }, -- Blackwater Whiptail
  ...
  [120301] = { { 1, PRI_OPEN }, nil, nil },
  [120302] = { { 1, PRI_OPEN }, nil, nil },                                   -- Create Armor Enhancement, Weapon Boost
  ...
  [128373] = { { 1, PRI_OPEN }, { SHIPYARD_HORDE, SHIPYARD_ALLIANCE }, {
    [FROSTFIRE_RIDGE1] = true,
    [FROSTFIRE_RIDGE2] = true,
    [FROSTFIRE_RIDGE3] = true,
    [FROSTFIRE_RIDGE4] = true,
    [FROSTFIRE_RIDGE5] = true,
    [FROSTFIRE_RIDGE6] = true,
    [FROSTFIRE_RIDGE7] = true,
    [FROSTFIRE_RIDGE8] = true,
    [FROSTFIRE_RIDGE9] = true,
    [SHADOWMOON_VALLEY1] = true,
    [SHADOWMOON_VALLEY3] = true,
    [SHADOWMOON_VALLEY3] = true
  } },                                                                                 -- Rush Order: Shipyard, special handling for sub-zone
  ...
  -- [143748] = { { 1, PRI_OPEN }, nil, nil },                                            -- Leyscale Koi (25 mana)
  ...
  -- Crests
  [240928] = { { 1, PRI_OPEN }, nil, nil }, -- Pouch of Weathered Crests
  [240927] = { { 1, PRI_OPEN }, nil, nil }, -- Satchel of Carved Crests
  [240926] = { { 1, PRI_OPEN }, nil, nil }, -- Pack of Runed Crests
  [240931] = { { 1, PRI_OPEN }, nil, nil }, -- Triumphant Satchel of Carved Crests
  [240930] = { { 1, PRI_OPEN }, nil, nil }, -- Celebratory Pack of Runed Crests
  [240929] = { { 1, PRI_OPEN }, nil, nil }, -- Glorious Cluster of Gilded Crests
